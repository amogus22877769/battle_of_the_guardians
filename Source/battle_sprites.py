...
class BattleSprites:
    def __init__(self, deck: list[Card]) -> None:
        ...
        self.energy_bar = EnergyBar(
            Bar(pygame.image.load('Resources/Images/EnergyBar.png'), RELATIVE_DEFAULT_ENERGY_BAR_SIZE, (0, 0),
                (DEFAULT_WIDTH, DEFAULT_HEIGHT)),
            Button(pygame.image.load('Resources/Images/EnergySign.png'), (0, 0), (
            ...
            Point(pygame.image.load('Resources/Images/EnergyEffect.jpeg'), RELATIVE_DEFAULT_ENERGY_BAR_SIZE, (0, 0),
