...
class String(pygame.sprite.Sprite):
    def __init__(self, text: str, color: pygame.Color, right_corner_relative_pos: tuple[float, float], font_path: Path, relative_size: float, window_size: tuple[int, int]) -> None:
