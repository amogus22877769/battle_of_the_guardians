...
class MenuSprites:
    def __init__(self, local_config: Config) -> None:
        ...
        self.menu: Background = Background(pygame.image.load('Resources/Images/DeckMap.jpeg'), (self.config.WIDTH, self.config.HEIGHT))
        self.battle_button: Button = Button(pygame.image.load('Resources/Images/BattleButton.png'), self.config.BATTLE_BUTTON_COORDINATES,
