class Config:
    def __init__(self) -> None:
        ...
        self.BATTLE_BUTTON_SIZE = (
            self.WIDTH * self.RELATIVE_BATTLE_BUTTON_SIZE, self.HEIGHT * self.RELATIVE_BATTLE_BUTTON_SIZE)
        ...
        self.MAXIMUM_AMOUNT_OF_HITPOINTS_IN_DEFAULT_HP_BAR = int(
            (self.DEFAULT_HP_BAR_SIZE[0] - 2 * self.DEFAULT_HP_BAR_THICKNESS[0]) / (
