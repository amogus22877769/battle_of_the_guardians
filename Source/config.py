...
ALL_ODD_OPPS_COORDINATES: list[tuple[float, float]] = [(RELATIVE_DISTANCE_BETWEEN_ODD_CARDS + RELATIVE_CARD_SIZE[0] / 2, ALL_EVEN_OPPS_COORDINATES[0][1]),
                                                       (RELATIVE_DISTANCE_BETWEEN_ODD_CARDS * 2 + RELATIVE_CARD_SIZE[0] / 2 * 3, ALL_EVEN_OPPS_COORDINATES[0][1]),
                                                       (RELATIVE_DISTANCE_BETWEEN_ODD_CARDS * 3 + RELATIVE_CARD_SIZE[0] / 2 * 5, ALL_EVEN_OPPS_COORDINATES[0][1])]
...
RELATIVE_WAVES_COUNTER_RELATIVE_CENTER_COORDINATES: tuple[float, float] = (0.9, RELATIVE_FANTASY_FONT_FOR_WAVES_COUNTER_SIZE / 2 * 1.4)
