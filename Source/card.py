...
class Card:
    ...
    def __init__(self, card_surface: pygame.Surface, outline_surface: pygame.Surface, card_size: tuple[int, int],
                 outline_thickness: tuple[int], hp_bar: Bar, hp_icon: Button, hitpoints: list[Point], health: float,
                 damage: float, font: pygame.font.Font) -> None:
        ...
        max_size_of_card: tuple[int, int] = (
            min(card_surface.get_width(), outline_surface.get_width()) + outline_thickness[0] * 2,
