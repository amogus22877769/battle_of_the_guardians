...
RELATIVE_LEADERBOARD_BUTTON_COORDINATES: tuple[float, float] = (0.85, 0.85)
RELATIVE_LEADERBOARD_BUTTON_SIZE: tuple[float, float] = (0.2, 0.2)
...
DRAFT_PICK_ANIMATION_DURATION: int = 1000
...
RELATIVE_CHANGE_HEALTH_FONT_SIZE: float = 0.04
CHANGE_HEALTH_DURATION: int = 1000

DEATH_EFFECT_ALPHA: int = 120
FREEZE_EFFECT_ALPHA: int = 150

RELATIVE_YOU_LOST_COORDINATES: tuple[float, float] = (0.5, 0.1)
RELATIVE_RESULT_COORDINATES: tuple[float, float] = (0.5, 0.23)
RELATIVE_SHARE_RESULT_COORDINATES: tuple[float, float] = (0.5, 0.89)
RELATIVE_FANTASY_FONT_FOR_YOU_LOST_SIZE: float = 0.1
RELATIVE_RETURN_BUTTON_COORDINATES: tuple[float, float] = (0.5, 0.40)
RELATIVE_RETURN_BUTTON_SIZE: tuple[float, float] = (0.25, 0.25)
RELATIVE_SHARE_BUTTON_COORDINATES: tuple[float, float] = (0.5, 0.67)
RELATIVE_SHARE_BUTTON_SIZE: tuple[float, float] = (0.15, 0.15)

INPUT_BOX_RELATIVE_SIZE: tuple[float, float] = (0.4, 0.2)
USERNAME_BOX_RELATIVE_COORDINATES: tuple[float, float] = (0.5, 0.3)
PASSWORD_BOX_RELATIVE_COORDINATES: tuple[float, float] = (0.5, 0.60)
INPUT_BOX_RELATIVE_OUTLINE_THICKNESS: tuple[float, float] = (0.0625, 0.053)
REGISTRATION_RELATIVE_COORDINATES: tuple[float, float] = (0.5, 0.05)
RELATIVE_FANTASY_FONT_FOR_REGISTRATION_SIZE: float = 0.07
USERNAME_STRING_RELATIVE_COORDINATES: tuple[float, float] = (0.5, 0.15)
PASSWORD_STRING_RELATIVE_COORDINATES: tuple[float, float] = (0.5, 0.45)
TRY_AGAIN_RELATIVE_COORDINATES: tuple[float, float] = (0.5, 0.8)

RELATIVE_LEADERBOARD_STRING_COORDINATES: tuple[float, float] = (0.5, 0.05)
RELATIVE_FANTASY_FONT_FOR_LEADERBOARD_STRING_SIZE: float = 0.075
RELATIVE_FANTASY_FONT_FOR_LEADERS_STRING_SIZE: float = 0.05
RELATIVE_LEADERS_STRING_DELTA: float = (1 - 10 * RELATIVE_FANTASY_FONT_FOR_LEADERS_STRING_SIZE - RELATIVE_FANTASY_FONT_FOR_LEADERBOARD_STRING_SIZE / 2 - RELATIVE_LEADERBOARD_STRING_COORDINATES[1]) / 11
RELATIVE_LEADERS_STRING_COORDINATES: tuple[tuple[float, float], ...] = tuple([(0.5, RELATIVE_FANTASY_FONT_FOR_LEADERBOARD_STRING_SIZE / 2 + RELATIVE_LEADERBOARD_STRING_COORDINATES[1] + RELATIVE_LEADERS_STRING_DELTA * (1 + i) +
                                                           RELATIVE_FANTASY_FONT_FOR_LEADERS_STRING_SIZE * (2 * i + 1) / 2) for i in range(10)])

RELATIVE_LEADERBOARD_RETURN_BUTTON_COORDINATES = (0.8, 0.8)
RELATIVE_LEADERBOARD_RETURN_BUTTON_SIZE = (0.3, 0.3)