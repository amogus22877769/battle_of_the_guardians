...
from frontend.src.battle_of_the_guardians.buffer import CURRENT_WINDOW_SIZE, score
from frontend.src.battle_of_the_guardians.config import ALL_CARD_COORDINATES, RELATIVE_DISTANCE_BETWEEN_CARD_AND_HP_BAR, \
...
from frontend.src.battle_of_the_guardians.structures.energy_bar import EnergyBar
