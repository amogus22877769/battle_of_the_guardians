...
from frontend.src.battle_of_the_guardians.config import DEFAULT_WIDTH, DEFAULT_HEIGHT, \
    ...
    WINDSTORM_SHADOW_HP, WINDSTORM_SHADOW_DMG, GHOST_BIRD_HP, GHOST_BIRD_DMG, DEATH_EFFECT_ALPHA, FREEZE_EFFECT_ALPHA
