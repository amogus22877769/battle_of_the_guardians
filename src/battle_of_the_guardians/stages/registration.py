...
from src.battle_of_the_guardians.controllers.front import registration
...
from src.battle_of_the_guardians.sprites_loaders.registration_sprites import RegistrationSprites
