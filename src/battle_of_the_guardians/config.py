...
RELATIVE_YOU_LOST_COORDINATES: tuple[float, float] = (0.5, 0.25)
RELATIVE_RESULT_COORDINATES: tuple[float, float] = (0.5, 0.4)
RELATIVE_FANTASY_FONT_FOR_YOU_LOST_SIZE: float = 0.1
RELATIVE_RETURN_BUTTON_COORDINATES: tuple[float, float] = (0.5, 0.65)
RELATIVE_RETURN_BUTTON_SIZE: tuple[float, float] = (0.3, 0.3)
RELATIVE_SHARE_BUTTON_COORDINATES: tuple[float, float] = (0.5, 0.8)
RELATIVE_SHARE_BUTTON_SIZE: tuple[float, float] = (0.15, 0.15)
RELATIVE_FANTASY_FONT_FOR_
